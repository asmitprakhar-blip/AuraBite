  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col order-1 md:order-2 md:p-5">
        ...
        <div className="hidden md:flex items-center gap-1 text-primary mb-2">
        ...
        <div className="hidden md:flex items-center justify-between gap-4 mt-auto">
          <Link href={`/menu/${item.id}`} className="flex-1">
            <button className="w-full py-2.5 rounded-xl bg-green-900 text-white font-semibold text-sm hover:bg-green-800 transition-all shadow-lg shadow-stone-200">
              Customise
            </button>
          </Link>
          <button
